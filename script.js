class Slider {
    ...
    setup() {
        ...
        //     this.renderer.setSize(window.innerWidth, window.innerWidth/ratio)
        // } else {
        //     this.renderer.setSize(window.innerHeight*ratio, window.innerHeight)
        // }
    ...
    loadTextures() {
        ...
        this.disp = loader.load('./pics/rock.png', this.render)
